...
func (tq *TokensQuery) GroupBy(field string, fields ...string) *TokensGroupBy {
	group := &TokensGroupBy{config: tq.config}
...
func (tq *TokensQuery) Select(field string, fields ...string) *TokensSelect {
	selector := &TokensSelect{config: tq.config}
...
func (tq *TokensQuery) sqlAll(ctx context.Context) ([]*Tokens, error) {
	var (
		nodes = []*Tokens{}
		_spec = tq.querySpec()
	)
...
func (tq *TokensQuery) sqlQuery() *sql.Selector {
	builder := sql.Dialect(tq.driver.Dialect())
	t1 := builder.Table(tokens.Table)
	selector := builder.Select(t1.Columns(tokens.Columns...)...).From(t1)
	if tq.sql != nil {
		selector = tq.sql
		selector.Select(selector.Columns(tokens.Columns...)...)
	}
...
func (tgb *TokensGroupBy) Strings(ctx context.Context) ([]string, error) {
	if len(tgb.fields) > 1 {
		return nil, errors.New("ent: TokensGroupBy.Strings is not achievable when grouping more than 1 field")
	}
	var v []string
	if err := tgb.Scan(ctx, &v); err != nil {
		return nil, err
...
func (tgb *TokensGroupBy) String(ctx context.Context) (_ string, err error) {
	...
	case 0:
		err = &NotFoundError{tokens.Label}
	default:
		err = fmt.Errorf("ent: TokensGroupBy.Strings returned %d results when one was expected", len(v))
	}
	return
}
...
func (tgb *TokensGroupBy) Ints(ctx context.Context) ([]int, error) {
	if len(tgb.fields) > 1 {
		return nil, errors.New("ent: TokensGroupBy.Ints is not achievable when grouping more than 1 field")
	}
	var v []int
	if err := tgb.Scan(ctx, &v); err != nil {
		return nil, err
...
func (tgb *TokensGroupBy) Int(ctx context.Context) (_ int, err error) {
	...
	case 0:
		err = &NotFoundError{tokens.Label}
	default:
		err = fmt.Errorf("ent: TokensGroupBy.Ints returned %d results when one was expected", len(v))
	}
	return
}
...
func (tgb *TokensGroupBy) Float64s(ctx context.Context) ([]float64, error) {
	if len(tgb.fields) > 1 {
		return nil, errors.New("ent: TokensGroupBy.Float64s is not achievable when grouping more than 1 field")
	}
	var v []float64
	if err := tgb.Scan(ctx, &v); err != nil {
		return nil, err
...
func (tgb *TokensGroupBy) Float64(ctx context.Context) (_ float64, err error) {
	...
	case 0:
		err = &NotFoundError{tokens.Label}
	default:
		err = fmt.Errorf("ent: TokensGroupBy.Float64s returned %d results when one was expected", len(v))
	}
	return
}
...
func (tgb *TokensGroupBy) Bools(ctx context.Context) ([]bool, error) {
	if len(tgb.fields) > 1 {
		return nil, errors.New("ent: TokensGroupBy.Bools is not achievable when grouping more than 1 field")
	}
	var v []bool
	if err := tgb.Scan(ctx, &v); err != nil {
		return nil, err
...
func (tgb *TokensGroupBy) Bool(ctx context.Context) (_ bool, err error) {
	...
	case 0:
		err = &NotFoundError{tokens.Label}
	default:
		err = fmt.Errorf("ent: TokensGroupBy.Bools returned %d results when one was expected", len(v))
	}
	return
}
...
func (tgb *TokensGroupBy) sqlScan(ctx context.Context, v interface{}) error {
	rows := &sql.Rows{}
...
func (ts *TokensSelect) Strings(ctx context.Context) ([]string, error) {
	if len(ts.fields) > 1 {
		return nil, errors.New("ent: TokensSelect.Strings is not achievable when selecting more than 1 field")
	}
	var v []string
	if err := ts.Scan(ctx, &v); err != nil {
		return nil, err
...
func (ts *TokensSelect) String(ctx context.Context) (_ string, err error) {
	...
	case 0:
		err = &NotFoundError{tokens.Label}
	default:
		err = fmt.Errorf("ent: TokensSelect.Strings returned %d results when one was expected", len(v))
	}
	return
}
...
func (ts *TokensSelect) Ints(ctx context.Context) ([]int, error) {
	if len(ts.fields) > 1 {
		return nil, errors.New("ent: TokensSelect.Ints is not achievable when selecting more than 1 field")
	}
	var v []int
	if err := ts.Scan(ctx, &v); err != nil {
		return nil, err
...
func (ts *TokensSelect) Int(ctx context.Context) (_ int, err error) {
	...
	case 0:
		err = &NotFoundError{tokens.Label}
	default:
		err = fmt.Errorf("ent: TokensSelect.Ints returned %d results when one was expected", len(v))
	}
	return
}
...
func (ts *TokensSelect) Float64s(ctx context.Context) ([]float64, error) {
	if len(ts.fields) > 1 {
		return nil, errors.New("ent: TokensSelect.Float64s is not achievable when selecting more than 1 field")
	}
	var v []float64
	if err := ts.Scan(ctx, &v); err != nil {
		return nil, err
...
func (ts *TokensSelect) Float64(ctx context.Context) (_ float64, err error) {
	...
	case 0:
		err = &NotFoundError{tokens.Label}
	default:
		err = fmt.Errorf("ent: TokensSelect.Float64s returned %d results when one was expected", len(v))
	}
	return
}
...
func (ts *TokensSelect) Bools(ctx context.Context) ([]bool, error) {
	if len(ts.fields) > 1 {
		return nil, errors.New("ent: TokensSelect.Bools is not achievable when selecting more than 1 field")
	}
	var v []bool
	if err := ts.Scan(ctx, &v); err != nil {
		return nil, err
...
func (ts *TokensSelect) Bool(ctx context.Context) (_ bool, err error) {
	...
	case 0:
		err = &NotFoundError{tokens.Label}
	default:
		err = fmt.Errorf("ent: TokensSelect.Bools returned %d results when one was expected", len(v))
	}
	return
}
...
func (ts *TokensSelect) sqlScan(ctx context.Context, v interface{}) error {
	rows := &sql.Rows{}
...
func (ts *TokensSelect) sqlQuery() sql.Querier {
	selector := ts.sql
